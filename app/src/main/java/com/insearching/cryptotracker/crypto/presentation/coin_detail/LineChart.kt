...
fun LineChart(
    ...
    Canvas(
        ...
        val xAxesLabelSpacingPx = style.xAxesLabelSpacing.toPx()
        ...
        val viewPortHeightPx = size.height -
                (maxXLabelHeight + 2 * verticalPaddingPx
                        + xLabelLineHeight + xAxesLabelSpacingPx)
        ...
        xLabelWidth = maxXLabelWidth + xAxesLabelSpacingPx
        xLabelTextLayoutResults.forEachIndexed { index, result ->
            val x = viewPortLeftX + xAxesLabelSpacingPx / 2f + xLabelWidth * index
            drawText(
                textLayoutResult = result,
                topLeft = Offset(
                    x = x,
                    y = viewPortBottomY + xAxesLabelSpacingPx
                ),
